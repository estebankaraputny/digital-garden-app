...
export class CreateNoteDto {
    ...
    @MaxLength(20, { message: 'El titulo debe tener menos de 20 caracteres'})
    title: string;
    ...
    @MaxLength(400, { message: 'El contenido debe tener menos de 400 caracteres'})
    content: string;
    ...
    @MaxLength(20, { message: 'La issue debe tener menos de 20 caracteres'})
    issue: string;
